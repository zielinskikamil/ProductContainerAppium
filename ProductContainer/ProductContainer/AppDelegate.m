...
- (void)addDefaultProducts {
    ...
    if(products.count < 1) {
        ...
        if ([_managedObjectContext save:&error]) {
            NSLog(@"Default product (Apple) Added");
        } else {
            if (error) {
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "AppiumApp.ProductContainer" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ProductContainer" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ProductContainer.sqlite"];
    NSError *error = nil;
